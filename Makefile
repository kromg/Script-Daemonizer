# This Makefile is for the Script::Daemonizer extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Script/Daemonizer.pm]
#     AUTHOR => [q[Giacomo Montagner <gmork@entirelyunlike.net>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Script::Daemonizer]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Script/Daemonizer.pm]
#     clean => { FILES=>q[Script-Daemonizer-*] }
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/giacomo/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Script/Daemonizer.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Script
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Script
...
TO_INST_PM = lib/Script/Daemonizer.pm

PM_TO_BLIB = lib/Script/Daemonizer.pm \
...
DISTNAME = Script-Daemonizer
DISTVNAME = Script-Daemonizer-0.01
...
manifypods : pure_all  \
	lib/Script/Daemonizer.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Script/Daemonizer.pm $(INST_MAN3DIR)/Script::Daemonizer.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Turns your script into a UNIX daemon process (the easy way).'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Giacomo Montagner <gmork@entirelyunlike.net>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Script-Daemonizer' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Turns your script into a UNIX daemon process (the easy way).",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Giacomo Montagner <gmork@entirelyunlike.net>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Script-Daemonizer",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Turns your script into a UNIX daemon process (the easy way).</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Giacomo Montagner &lt;gmork@entirelyunlike.net&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Script/Daemonizer.pm blib/lib/Script/Daemonizer.pm 
